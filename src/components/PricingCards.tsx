...
const PAYPAL_ME = "https://www.paypal.me/michelmartin360mm";
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 px-4 backdrop-blur-sm">
      <div className="w-full max-w-md rounded-3xl bg-[#0e1118] p-6 ring-1 ring-white/10">
        ...
        {!method && (
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center gap-4 rounded-2xl bg-[#0070BA]/10 px-5 py-4 ring-1 ring-[#0070BA]/30 hover:ring-[#0070BA]/60 transition-all text-left"
            >
              <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-[#0070BA]/20">
              ...
              <span className="text-xs font-bold text-[#0070BA]">${usdAmount}</span>
            </button>

            {/* Coming soon - Paystack */}
            <div className="w-full flex items-center gap-4 rounded-2xl bg-white/3 px-5 py-4 ring-1 ring-white/5 opacity-50">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-slate-400">Nigerian cards, USSD, bank transfer</p>
              </div>
        ...
        {method === "paypal" && (
          <div className="rounded-2xl bg-[#0070BA]/10 p-5 ring-1 ring-[#0070BA]/30 space-y-3">
            <p className="font-bold text-white">PayPal opened ✓</p>
            <ol className="space-y-1.5 text-sm text-slate-300 list-decimal list-inside">
              ...
              <li>Send to us on WhatsApp with your Vytora email</li>
              <li>Account upgraded within 2 hours</li>
            </ol>
            <a
              href={`https://wa.me/2349073965030?text=Hi%2C%20I%20paid%20for%20Vytora%20${encodeURIComponent(plan.name)}%20via%20PayPal.%20Here%20is%20my%20receipt.`}
              target="_blank"
